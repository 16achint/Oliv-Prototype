...
export default function Frame8() {
  return (
    <div className="mt-20 grid grid-cols-4 gap-5 mb-20">
      <div className="flex flex-col space-y-5">
        <img
          className="w-fit mb-14 flex items-center"
        ...
        <div className="flex space-x-8 justify-start items-center">
          <a
            href="#"
            className="rounded-full bg-gray-100 hover:bg-gray-200 p-2 cursor-pointer"
          >
            <svg
              width="18"
              height="18"
      ...
      <div className="flex flex-col space-y-10">
        <div className="flex flex-col space-y-2">
          <h3 className="text-xl font-sans"> Pages</h3>
          <HorizontalLine />
        </div>
        <ul className="flex flex-col space-y-4 font-sans">
          <TagButton label={"Home"} />
          <TagButton label={"Services"} />
          <TagButton label={"About"} />
          <TagButton label={"Jobs"} />
          <TagButton label={"Contact"} />
        </ul>
        <Button label={"More Templates"} />
      </div>
      <div className="flex flex-col space-y-10">
        <div className="flex flex-col space-y-2">
          <h3 className="text-xl font-sans"> CMS</h3>
          <HorizontalLine />
        </div>
        <ul className="flex flex-col space-y-4 font-sans">
          <TagButton label={"Work"} />
          <TagButton label={"Work Single"} />
          <TagButton label={"Blog"} />
          <TagButton label={"Shop"} />
          <TagButton label={"Shop Single"} />
        </ul>
      </div>
      <div className="flex flex-col space-y-10">
        <div className="flex flex-col space-y-2">
          <h3 className="text-xl font-sans">Utility Pages</h3>
          <HorizontalLine />
        </div>
        <ul className="flex flex-col space-y-4 font-sans">
          <TagButton label={"404 Error Page"} />
          <TagButton label={"Password Protected"} />
          <TagButton label={"Styleguide"} />
          <TagButton label={"Licensing"} />
          <TagButton label={"Changelog"} />
        </ul>
      </div>
    </div>
  );
